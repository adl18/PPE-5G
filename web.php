<form action ="solution.php" method= "get" >
    ...
    <input type="number" step="0.01" min="0" name="surface" pattern="\d+" required />
    <br>
    <label for="latence"> Latence en milliseconde:</label>
    <input type="number" step="0.01" min="0" name="latence"pattern="\d+" required/>
    <br>
    <label for="debit"> Débit en Gb/s:</label>
    <input type="number" step="0.01" min="0" name="debit"pattern="\d+" required/>
    <br>
